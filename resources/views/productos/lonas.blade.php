...
<div class="container">
    ...
    <div class="info">
        ...
        <p>
            Lonas publicitarias resistentes y de alta calidad,
            ideales para negocios, eventos o promociones.
        </p>

        <div class="price">$100.00 MXN m²</div>

        <ul>
            <li>✔ Material resistente al clima</li>
            <li>✔ Impresión de alta resolución</li>
            <li>✔ Ideal para exteriores e interiores</li>
        </ul>

        <a href="{{ route('cotizar', 1) }}" class="btn">Cotizar Lona</a>
    </div>
    ...
    <div class="carousel">
        ...
        <div class="slides">
            <div class="slide"><img src="{{ asset('images/lonasoul.png') }}"></div>
            <div class="slide"><img src="{{ asset('images/lona2.png') }}"></div>
            <div class="slide"><img src="{{ asset('images/lona3.png') }}"></div>
            <div class="slide"><img src="{{ asset('images/lona4.png') }}"></div>
            <div class="slide"><img src="{{ asset('images/lona5.png') }}"></div>
            <div class="slide"><img src="{{ asset('images/lona6.png') }}"></div>
        </div>
